...
//        scrollVMain.sh_scrollViewPopGestureRecognizerEnable = true
        ...
        for num in 0..<4{
            ...
            switch num {
            case 0:
                coverNVC0 = LikeGoodsVC(nibName: "LikeGoodsVC", bundle: nil)
...
extension LikeMainVC:UIScrollViewDelegate{
...
extension LikeMainVC:UICollectionViewDataSource,UICollectionViewDelegate{
...
extension LikeMainVC:UICollectionViewDelegateFlowLayout{
