...
class INOScrollView: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    var imageArray: [Any]? {
        didSet{
            ...
            PrintFM("topImages = \(String(describing: imageArray))");
...
//        pageControl.addTarget(self, action: #selector(pageChanged(sender:)), for: .valueChanged)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if item is UIImage {
            ...
            if (item as! String).components(separatedBy: "http").count > 1{
                ...
                cell.imageView.image = BundlePngWithName(item as! String)
            }
